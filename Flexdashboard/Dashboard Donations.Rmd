...
reactiveDonorsSourceGroup <- reactive({
  ...
  donation.date <= input$dateid2[2],
  nominal == input$nominalid2,
  source.group == input$sourcegroupid2,
  index == input$graphid2
  )
...
renderPlotly({
  ...
  geom_line())
  } else if ((input$levelsid2 == "By Source Group")) {
  ggplotly(isolate(reactiveDonorsSourceGroup()) %>%
  ggplot(
  aes(
  donation.month,
  sum.new.donors,
  ...
  geom_line())
  } else if ((input$levelsid2 == "By Source Code")) {
  ggplotly(isolate(reactiveDonorsSource()) %>%
  ggplot(
  aes(
  donation.month,
  sum.new.donors,
  ...
  geom_line())
  } else if ((input$levelsid2 == "General")) {
  ggplotly(isolate(reactiveDonorsTotal()) %>%
  ggplot(
  aes(
  donation.month,
  sum.new.donors,
